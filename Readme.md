...
Here are some screenshots of LogViewer in action.
...
Watch List with history support which can be synchronized with the message list to monitor the values at any given time.
