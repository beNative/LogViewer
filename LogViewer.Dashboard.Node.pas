...
{$REGION 'documentation'}
{
  ...
  nodes:
  https://stackoverflow.com/questions/5365365
...
type
  ...
  private
    ...
    FNodes      : Lazy<IDictionary<UInt32, TDashboardNode>>;
  ...
  protected
    ...
    function GetNodes: IDictionary<UInt32, TDashboardNode>;
  ...
  public
    ...
    property Nodes: IDictionary<UInt32, TDashboardNode>
      read GetNodes;
...
begin
  FNodes.Create(function: IDictionary<UInt32, TDashboardNode>
    begin
      Result := TCollections.CreateDictionary<UInt32, TDashboardNode>;
    end
  );
  FVTNode := AVTNode;
  FVTree  := AVTree;
...
function TDashboardNode.GetNodes: IDictionary<UInt32, TDashboardNode>;
begin
  Result := FNodes.Value;
end;
