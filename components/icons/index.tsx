...
const iconDefs = {
    ...
    Clipboard: {
        ...
        solid: (props: React.SVGProps<SVGSVGElement>) => (
            <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
                <path fillRule="evenodd" d="M10.5 3A2.25 2.25 0 008.25 5.25v.041a2.25 2.25 0 01-1.841 2.208 9.06 9.06 0 001.15.124h.01a9.06 9.06 0 001.5-.124 2.25 2.25 0 01-1.841-2.208V5.25A2.25 2.25 0 006 3h4.5zm2.25 0a2.25 2.25 0 00-2.25 2.25v.041a2.25 2.25 0 011.841 2.208 9.06 9.06 0 00-1.15.124h-.01a9.06 9.06 0 00-1.5-.124 2.25 2.25 0 011.841-2.208V5.25A2.25 2.25 0 0010.5 3h1.5zM15 3a2.25 2.25 0 012.25 2.25v.041a2.25 2.25 0 001.841 2.208 9.06 9.06 0 01-1.15.124h-.01a9.06 9.06 0 01-1.5-.124 2.25 2.25 0 001.841-2.208V5.25A2.25 2.25 0 0115 3h1.5z" clipRule="evenodd" />
                <path d="M3 9.375A2.625 2.625 0 015.625 6.75h12.75A2.625 2.625 0 0121 9.375v9A2.625 2.625 0 0118.375 21H5.625A2.625 2.625 0 013 18.375v-9z" />
            </svg>
        )
    },
    Clock: {
